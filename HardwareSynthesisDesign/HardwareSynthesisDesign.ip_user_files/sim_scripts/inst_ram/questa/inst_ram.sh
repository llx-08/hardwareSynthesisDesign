...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="D:/thirdyear/hardwareSysthesis/git-okWithLandS/git-add_hazard/git-add_hazard/HardwareSynthesisDesign/HardwareSynthesisDesign.cache/compile_simlib/questa"
  fi
